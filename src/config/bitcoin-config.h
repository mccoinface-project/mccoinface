...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Mccoinface Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Mccoinface Core"
...
#define PACKAGE_BUGREPORT "https://github.com/mccoinface-project/mccoinface/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Mccoinface Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Mccoinface Core 0.21.2.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "mccoinface"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://mccoinface.org/"

/* Define to the version of this package. */
#define PACKAGE_VERSION "0.21.2.2"
