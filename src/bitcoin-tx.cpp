...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " mccoinface-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  mccoinface-tx [options] <hex-tx> [commands]  Update hex-encoded mccoinface transaction\n" +
            "or:     mccoinface-tx [options] -create [commands]   Create hex-encoded mccoinface transaction\n" +
            "\n";
