...
QString BitcoinUnits::longName(int unit)
{
    switch(unit)
    {
    case BTC: return QString("MCF");
    case mBTC: return QString("microface");
    case uBTC: return QString("nanoface");
    case SAT: return QString("picoface");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Mccoinfaces");
