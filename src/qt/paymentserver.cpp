...
const QString BITCOIN_IPC_PREFIX("mccoinface:");
    ...
    if (startLocalServer)
    {
        ...
        if (!uriServer->listen(name)) {
            ...
            QMessageBox::critical(nullptr, tr("Payment request error"),
                tr("Cannot start mccoinface: click-to-pay handler"));
        }
        else {
...
void PaymentServer::handleURIOrFile(const QString& s)
{
    ...
    if (s.startsWith("mccoinface://", Qt::CaseInsensitive))
    {
        Q_EMIT message(tr("URI handling"), tr("'mccoinface://' is not a valid URI. Use 'mccoinface:' instead."),
    ...
    else if (s.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // bitcoin: URI
    {
        ...
        // normal URI
        {
            ...
            if (GUIUtil::parseBitcoinURI(s, &recipient))
            {
                ...
                Q_EMIT message(tr("URI handling"),
                    tr("URI cannot be parsed! This can be caused by an invalid Mccoinface address or malformed URI parameters."),
                    CClientUIInterface::ICON_WARNING);
