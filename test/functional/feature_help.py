...
"""Verify that starting mccoinface with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start mccoinface with -h for help text")
        ...
        self.log.info("Start mccoinface with -version for version information")
        ...
        self.log.info("Start mccoinfaced with -fakearg to make sure it does not start")
