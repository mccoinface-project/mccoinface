# Support for Output Descriptors in Mccoinface Core

Since Mccoinface Core v0.17, there is support for Output Descriptors. This is a
...
existing Mccoinface Core wallets, a convenience function `combo` is
