Mccoinface Core version *0.15.1* is now available from:

  <https://download.mccoinface.org/mccoinface-0.15.1/>
...
A number of changes to the way Mccoinface Core deals with peer connections and invalid blocks
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 microface per kB (0.00001 MCF). This is to prepare for dropping the minimum transaction fee to 0.1 microface per kB (0.0001 MCF) in the next release.
