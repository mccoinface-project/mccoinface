Contributing to Mccoinface Core
============================

The Mccoinface Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the Mccoinface Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/mccoinface-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to mccoinface-qt
...
The following applies to code changes to the Mccoinface Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Mccoinface
Network Protocol consensus changes.

Whether a pull request is merged into Mccoinface Core rests with the project merge
...
Patches that change Mccoinface consensus rules are considerably more involved than
...
Where a patch set proposes to change the Mccoinface consensus, it must have been
...
The project leader is the release manager for each Mccoinface Core release.
